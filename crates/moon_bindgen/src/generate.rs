...
fn external_pointer_type(_ty: &Type, _type_rename: fn(String) -> String) -> Option<String> {
    None
}
...
fn moon_parameter_type(
    ...
    _function: &str,
    _parameter: &str,
    _resolver: &dyn Fn(&str, NullabilityPosition) -> Nullability,
    type_rename: fn(String) -> String,
) -> Option<String> {
...
"#,
        ...
        assert!(moon.contains("pub extern \"c\" fn get_default() -> @c.Pointer[Context]"));
        assert!(moon.contains("pub extern \"c\" fn get_nonnull() -> @c.Pointer[Context]"));
        assert!(moon.contains("pub extern \"c\" fn set_default(value : @c.Pointer[Context])"));
        assert!(moon.contains("pub extern \"c\" fn set_nullable(value : @c.Pointer[Context])"));
