...
impl Bindings {
    ...
    pub(crate) fn with_c_stub_affixes(mut self, header: &str, footer: &str) -> Self {
        ...
        const GENERATED_COMMENT: &str = "// Generated by moon-bindgen. Do not edit.\n";
        let generated = self
            .c_stub
            .strip_prefix(GENERATED_COMMENT)
            .unwrap_or(&self.c_stub);
        let mut source = String::from(GENERATED_COMMENT);
        if !header.is_empty() {
